...
#ifndef COMBINEIDFT_HPP_
#define COMBINEIDFT_HPP_

#include <tdeParams.hpp>

#ifdef TDE_APP
class CombineIdft : public ActorExecutor
{
private:
	float *w;
	int n;
public:
	CombineIdft (Actor *actor) : ActorExecutor(actor)
	{
		n = 0;
		w = NULL;
	}
	...
	{
		string actorNamePrefix = "CombineIdft";
